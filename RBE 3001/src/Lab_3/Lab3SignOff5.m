...
%P1 to P2
trajPlannerP1toP2Joint1 = trajPlanner.quintic_traj(0, 1.8, 0, 0, jointAngle1(1,1), jointAngle2(1,1), 0, 0);
trajPlannerP1toP2Joint2 = trajPlanner.quintic_traj(0, 1.8, 0, 0, jointAngle1(1,2), jointAngle2(1,2), 0, 0);
trajPlannerP1toP2Joint3 = trajPlanner.quintic_traj(0, 1.8, 0, 0, jointAngle1(1,3), jointAngle2(1,3), 0, 0);
trajPlannerP1toP2Joint4 = trajPlanner.quintic_traj(0, 1.8, 0, 0, jointAngle1(1,4), jointAngle2(1,4), 0, 0);

P1toP2 = [trajPlannerP1toP2Joint1 trajPlannerP1toP2Joint2 trajPlannerP1toP2Joint3 trajPlannerP1toP2Joint4];

%P2 to P3
trajPlannerP2toP3Joint1 = trajPlanner.quintic_traj(0, 1.7, 0, 0, jointAngle2(1,1), jointAngle3(1,1), 0, 0);
trajPlannerP2toP3Joint2 = trajPlanner.quintic_traj(0, 1.7, 0, 0, jointAngle2(1,2), jointAngle3(1,2), 0, 0);
trajPlannerP2toP3Joint3 = trajPlanner.quintic_traj(0, 1.7, 0, 0, jointAngle2(1,3), jointAngle3(1,3), 0, 0);
trajPlannerP2toP3Joint4 = trajPlanner.quintic_traj(0, 1.7, 0, 0, jointAngle2(1,4), jointAngle3(1,4), 0, 0);
P2toP3 = [trajPlannerP2toP3Joint1 trajPlannerP2toP3Joint2 trajPlannerP2toP3Joint3 trajPlannerP2toP3Joint4];

%P3 to P2
trajPlannerP3toP1Joint1 = trajPlanner.quintic_traj(0, 1.7, 0, 0, jointAngle3(1,1), jointAngle1(1,1), 0, 0);
trajPlannerP3toP1Joint2 = trajPlanner.quintic_traj(0, 1.7, 0, 0, jointAngle3(1,2), jointAngle1(1,2), 0, 0);
trajPlannerP3toP1Joint3 = trajPlanner.quintic_traj(0, 1.7, 0, 0, jointAngle3(1,3), jointAngle1(1,3), 0, 0);
trajPlannerP3toP1Joint4 = trajPlanner.quintic_traj(0, 1.7, 0, 0, jointAngle3(1,4), jointAngle1(1,4), 0, 0);
P3toP1 = [trajPlannerP3toP1Joint1 trajPlannerP3toP1Joint2 trajPlannerP3toP1Joint3 trajPlannerP3toP1Joint4];


       

        A = robot.run_trajectory(P1toP2, 1.8, 0);
        B = robot.run_trajectory(P2toP3, 1.7, 0);
        C = robot.run_trajectory(P3toP1, 1.7, 0);
        A = A(1:1650, :);
     ...
     subplot(3,1,2)
        hold on
      plot(X(1:amntRow-1), diff(Ya4), 'LineWidth', 3, 'DisplayName', 'X Value');
     plot(X(1:amntRow-1), diff(Ya5), 'LineWidth', 3, 'DisplayName', 'Y Value');
     plot(X(1:amntRow-1), diff(Ya6), 'LineWidth', 3, 'DisplayName', 'Z Value');
     ...
     subplot(3,1,3)
      hold on
      plot(X(1:amntRow-2), diff(diff(Ya4)), 'LineWidth', 3, 'DisplayName', 'X Value');
     plot(X(1:amntRow-2), diff(diff(Ya5)), 'LineWidth', 3, 'DisplayName', 'Y Value');
     plot(X(1:amntRow-2), diff(diff(Ya6)), 'LineWidth', 3, 'DisplayName', 'Z Value');
