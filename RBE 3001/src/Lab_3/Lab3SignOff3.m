...
%P1 to P2
trajPlannerP1toP2Joint1 = trajPlanner.cubic_traj(0, 1.8, 0, 0, jointAngle1(1,1), jointAngle2(1,1));
trajPlannerP1toP2Joint2 = trajPlanner.cubic_traj(0, 1.8, 0, 0, jointAngle1(1,2), jointAngle2(1,2));
trajPlannerP1toP2Joint3 = trajPlanner.cubic_traj(0, 1.8, 0, 0, jointAngle1(1,3), jointAngle2(1,3));
trajPlannerP1toP2Joint4 = trajPlanner.cubic_traj(0, 1.8, 0, 0, jointAngle1(1,4), jointAngle2(1,4));

P1toP2 = [trajPlannerP1toP2Joint1 trajPlannerP1toP2Joint2 trajPlannerP1toP2Joint3 trajPlannerP1toP2Joint4];

%P2 to P3
trajPlannerP2toP3Joint1 = trajPlanner.cubic_traj(0, 1.7, 0, 0, jointAngle2(1,1), jointAngle3(1,1));
trajPlannerP2toP3Joint2 = trajPlanner.cubic_traj(0, 1.7, 0, 0, jointAngle2(1,2), jointAngle3(1,2));
trajPlannerP2toP3Joint3 = trajPlanner.cubic_traj(0, 1.7, 0, 0, jointAngle2(1,3), jointAngle3(1,3));
trajPlannerP2toP3Joint4 = trajPlanner.cubic_traj(0, 1.7, 0, 0, jointAngle2(1,4), jointAngle3(1,4));
P2toP3 = [trajPlannerP2toP3Joint1 trajPlannerP2toP3Joint2 trajPlannerP2toP3Joint3 trajPlannerP2toP3Joint4];

%P3 to P2
trajPlannerP3toP1Joint1 = trajPlanner.cubic_traj(0, 1.7, 0, 0, jointAngle3(1,1), jointAngle1(1,1));
trajPlannerP3toP1Joint2 = trajPlanner.cubic_traj(0, 1.7, 0, 0, jointAngle3(1,2), jointAngle1(1,2));
trajPlannerP3toP1Joint3 = trajPlanner.cubic_traj(0, 1.7, 0, 0, jointAngle3(1,3), jointAngle1(1,3));
trajPlannerP3toP1Joint4 = trajPlanner.cubic_traj(0, 1.7, 0, 0, jointAngle3(1,4), jointAngle1(1,4));
P3toP1 = [trajPlannerP3toP1Joint1 trajPlannerP3toP1Joint2 trajPlannerP3toP1Joint3 trajPlannerP3toP1Joint4];
     ...
     ylabel('Y Value (mm)')
     zlabel('Z Value (mm)')
     %writematrix([Ya4, Ya5, Ya6], 'cubicJoint.csv');
     hold off
     legend
